...
function detailTemplate(data) {
    ...
    const statementAdd = line => {
        ...
        if (line.addStatement === 'yes') {
            ...
            return `<span class="cline-any cline-addStatement-yes">已覆盖${line.addStatementNum}</span>`;
            } else if (line.addStatementCovered === 'no')
            return `<span class="cline-any cline-addStatement">未覆盖${line.addStatementNum}</span>`;
        }
    }
...
const summaryTableHeader = [
    ...
    '   <th data-col="pic" data-type="number" data-fmt="html" data-html="true" class="pic">Increments Progress</th>',
    // '   <th data-col="increments_raw" data-type="number" data-fmt="html" data-html="true" class="pic"></th>',
    '   <th data-col="increments" data-type="number" data-fmt="pct" class="pct">Rate</th>',
    '   <th data-col="increments_raw" data-type="number" data-fmt="html" class="abs">Info</th>',
...
function summaryLineTemplate(details) {
    ...
    return []
        .concat(
            ...
            summaryType('increments',true),
            summaryType('statements'),
        ...
        children.forEach(child => {
            ...
            const reportClasses = isEmpty
                ...
                : {
                      ...
                      increments: context.classForPercent(
                          'increments',
                          metrics?.increments?.pct || 100
                      )
                  };
